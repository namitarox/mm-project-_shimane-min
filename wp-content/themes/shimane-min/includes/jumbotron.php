<div class="p-news__top-item <?php if(is_home()) print 'front-page' ?>">
  <a href="<?php the_permalink();?>" class="p-news__top-inner">
    <div class="p-news__top-img <?php if(is_home()) print 'front-page' ?>">
      <?php
    ...
    <div class="p-news__top-text-wrap <?php if(is_home()) print 'front-page' ?>">
